...
async function apiCall(url, params) {
	...
	var api_host = 'https://api.bithumb.com' + url;
	var httpHeaders = getHttpHeaders(url, rgParams, '96fd47f55236832f47351c872ea0ead1', '0e0ea978382f39c505c7b1419ece9892');

	// var rgResult = rq(api_host, 'POST', rgParams, httpHeaders);
...
let getHttpHeaders = function(endPoint, rgParams, api_key, api_secret) {
